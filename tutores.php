...
$sentencia=$conexion->prepare("SELECT * FROM tutores");
$sentencia->execute();
...
?> 
  ...
  <div class="card">
    ...
    <a name="" id="" class="btn btn-dark" href="<?php echo $ruta_base ?>crear_tutor.php" role="button">Quiero Ofrecer Tutorias</a>       
    </div>
    <div class="card-body">
