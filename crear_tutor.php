...
if($_POST){
  ...
  //preparar insercion
$sentencia=$conexion->prepare("INSERT INTO tutores (nombres, apellidos, foto, correo, telefono, materia)
...
<div class="card">
   ...
   <button type="submit" class="btn btn-success">Agregar Estudiante</button>
      <a name="" id="" class="btn btn-danger" href="tutores.php" role="button">Cancelar</a>
   </div>
      </form>
</div>
</div>
